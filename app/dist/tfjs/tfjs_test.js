...
// Measured in pixels.
var EPSILON_IMAGE = 5;
(0, jasmine_util_1.describeWithFlags)('TFJS FaceMesh ', jasmine_util_1.ALL_ENVS, function () {
    var timeout;
    beforeAll(function () {
...
(0, jasmine_util_1.describeWithFlags)('TFJS FaceMesh static image ', jasmine_util_1.BROWSER_ENVS, function () {
    var image;
    var timeout;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        detector = _a.sent();
                        return [4 /*yield*/, (0, mediapipe_test_1.expectFaceMesh)(detector, image, staticImageMode, refineLandmarks, numFrames, EPSILON_IMAGE)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    mediapipeKeypoints = mediapipeResults
                        ...
                        keypoint.name]; }); })
                        .flat();
                    (0, test_util_1.expectArraysClose)(tfjsKeypoints.map(function (keypoint) { return [keypoint[0], keypoint[1], keypoint[2]]; }), mediapipeKeypoints.map(function (keypoint) { return [keypoint[0], keypoint[1], keypoint[2]]; }), EPSILON_IMAGE);
                    (0, test_util_1.expectArraysEqual)(tfjsKeypoints.map(function (keypoint) { return keypoint[3]; }), mediapipeKeypoints.map(function (keypoint) { return keypoint[3]; }));
